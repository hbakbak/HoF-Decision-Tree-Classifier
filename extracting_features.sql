...
-- Data Cleansing for the Task A table
...
-- Data Cleansing for the Task B table
...
-- Extracting csv files for Task A and Task B respectively. We ended up using the code provided by Dr. Golab in piazza (@155) since we were having file privilege problems but if not we would use this
-- For Task A: mysql -B -h manta.uwaterloo.ca -u user_mm4siddi -p ece356db_mm4siddi -e "select * from taska_out" | sed 's/\t/,/g' > taska_extracted.csv
-- For Task A: mysql -B -h manta.uwaterloo.ca -u user_mm4siddi -p ece356db_mm4siddi -e "select * from taskb_out" | sed 's/\t/,/g' > taskb_extracted.csv

/*
SELECT * FROM taska_out
INTO OUTFILE 'C:/Users/mushi/Downloads/lahman/taska_extracted.csv'
FIELDS ENCLOSED BY '"' 
TERMINATED BY ';' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';
...
INTO OUTFILE 'C:/Users/mushi/Downloads/lahman/taskb_extracted.csv'
FIELDS ENCLOSED BY '"' 
TERMINATED BY ';' 
ESCAPED BY '"' 
LINES TERMINATED BY '\r\n';
