...
t = ['Years_Batted','totGB', 'totRB', 'totHB', 'tot2B', 'tot3B', 'totHRB', 'totSOB', 'Years_Pitched', 'totGP', 'totW', 'totL', 'totIPOuts', 'totHP', 'totRP', 'totER', 'totBB', 'totSOP', 'totHRP', 'Years_Fielded', 'totGF', 'totA', 'totPO', 'totE', 'totDP', 'totPB', 'totCS', 'totInnOuts',
...
# }
# #After initially creating a DecisionTree model, we use the default scoring to fit the object.
# #Using the param_dict, we will find the best fit for the model. GridSearch allows us to test
